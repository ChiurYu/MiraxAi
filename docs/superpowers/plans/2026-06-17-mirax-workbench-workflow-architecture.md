...
**下一步：** 当前创建计划的任务已完成；后续执行本计划时从 Task 1 开始。先完成本 P0 计划；再按 `ui-ux-and-phase-4-handoff.md` 完成 P0「设置 / Provider / sidecar 配置」和「发布准备与 mock 发布任务」两个计划。
...
- [ ] **Step 1：创建 composables 目录并写入 composable**
